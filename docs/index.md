...
**Engine model** (`skene-context/engine.yaml`) — A YAML model generated by `build` that captures subjects and features, including optional action definitions for trigger/runtime behavior.
