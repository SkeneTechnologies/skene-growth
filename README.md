...
2. **Plan** - Generates a growth plan using Council of PLG analysis. This command uses an LLM to analyze your manifest and template to produce a detailed growth plan with 3-5 selected high-impact growth loops, implementation roadmap, and recommendations.
...
Generate a growth plan using Council of PLG analysis. This command uses an LLM to analyze your manifest and template to produce actionable growth recommendations.
