...
- **Objectives** - Generate targeted growth objectives before running plan for more focused recommendations
...
Generate a strategic growth plan using Council of PLG analysis. This command uses an LLM to analyze your manifest, template, and optionally objectives to produce actionable growth recommendations.
...
**Optional:**
- `growth-objectives.md` file (for targeted analysis aligned with current goals)

```bash
# Generate growth plan (auto-detects manifest and template)
uvx skene-growth plan --api-key "your-key"

# Include objectives for more targeted analysis
uvx skene-growth plan --objectives ./objectives.md --api-key "your-key"

# Use custom loops from CSV
uvx skene-growth plan --csv loops.csv --api-key "your-key"

# Specify all files explicitly
uvx skene-growth plan --manifest ./manifest.json --template ./template.json --objectives ./objectives.md
...
- `--manifest`: Path to growth-manifest.json (auto-detected if not specified)
- `--template`: Path to growth-template.json (auto-detected if not specified)
- `--objectives`: Path to growth-objectives.md (optional, auto-detected if available)
...
**Council of PLG Analysis:**
The plan command uses a "Council of PLG" system prompt that acts as an elite advisory board of growth strategists. It provides:
- Strategic assessment of current state and opportunities
