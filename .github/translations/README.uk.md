...
Skene -- це набір інструментів для аналізу кодової бази, орієнтований на продуктове зростання. Він сканує вашу кодову базу, виявляє можливості для зростання та генерує дієві плани впровадження.
